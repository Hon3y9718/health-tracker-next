// Small stroke-based nav icons -- hand-rolled rather than pulling in an icon library for
// five glyphs. All inherit color via currentColor and default to a 20px box.
...
export function GoalIcon({ className = base }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" className={className}>
      <circle cx="12" cy="12" r="9" />
